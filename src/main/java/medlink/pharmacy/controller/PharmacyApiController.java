...
public class PharmacyApiController {
    ...
    public ResponseEntity<Map<String, Object>> search(
        ...
        List<PharmacyResponse> items = pharmacyService.searchNearby(latitude, longitude, radius);
    ...
    public ResponseEntity<PharmacyResponse> detail(@PathVariable String pharmacyId) {
