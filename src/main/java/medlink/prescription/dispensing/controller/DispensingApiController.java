package medlink.prescription.dispensing.controller;

import lombok.RequiredArgsConstructor;
import medlink.prescription.dispensing.dto.DispensingStatus;
import medlink.prescription.dispensing.service.DispensingService;
...
public class DispensingApiController {
    ...
    public ResponseEntity<DispensingStatus> getStatus(@PathVariable String dispensingId) {
